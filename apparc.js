...
var redirectUnsetSession = function (req, res, next) {
	if(req.path == "/") {
		next()
...
x.use(redirectUnsetSession) // order matters!
...
x.post("/address",function(req,res){
...
x.get("/hold_time",function(req,res){
	res.render("02_hold_time.ejs",{ts:ts,x:req.session.financials});
});

x.post("/hold_time",function(req,res){
...
x.get("/budget",function(req,res){
	res.render("03_budget.ejs",{ts:ts,x:req.session.financials})
})

x.post("/budget",function(req,res){
...
x.get("/debt",function(req,res){
	res.render("04_debt.ejs",{ts:ts,x:req.session.financials})
})

x.post("/debt",function(req,res){
...
x.get("/rental_income_HM",function(req,res){
	res.render("05_rental_income_HM.ejs",{ts:ts,x:req.session.financials});
});

x.post("/rental_income_HM",function(req,res){
...
x.get("/rental_income",function(req,res){
	res.render("06_rental_income.ejs",{ts:ts,x:req.session.financials});
});

x.post("/rental_income",function(req,res){
...
x.get("/other_rental_inputs",function(req,res){
	res.render("07_other_rental_inputs.ejs",{ts:ts,x:req.session.financials});
});

x.post("/other_rental_inputs",function(req,res){
...
x.get("/other_income",function(req,res){
	res.render("08_other_income.ejs",{ts:ts,x:req.session.financials});
});

x.post("/other_income",function(req,res){
...
x.get("/how_many_expenses",function(req,res){
	res.render("09_how_many_expenses.ejs",{ts:ts,x:req.session.financials});
});

x.post("/how_many_expenses",function(req,res){
...
x.get("/expenses",function(req,res){
	res.render("10_expenses.ejs",{ts:ts,x:req.session.financials});
});

x.post("/expenses",function(req,res){
	var i = 0;
...
x.get("/is_there_refinance",function(req,res){
	res.render("11_is_there_refinance.ejs",{ts:ts,x:req.session.financials});
});

x.post("/is_there_refinance",function(req,res){
...
x.get("/refinance_sizing",function(req,res){
	res.render("12_refinance_sizing.ejs",{ts:ts,x:req.session.financials});
});

x.post("/refinance_sizing",function(req,res){
...
x.get("/refinance_debt_service",function(req,res){
	res.render("13_refinance_debt_service.ejs",{ts:ts,x:req.session.financials});
});

x.post("/refinance_debt_service",function(req,res){
...
x.get("/refinance_will_not_work",function(req,res){
	res.render("14_refinance_will_not_work.ejs",{ts:ts,x:req.session.financials});
});

x.post("/refinance_will_not_work",function(req,res){
...
x.get("/sale",function(req,res){
	res.render("15_sale.ejs",{ts:ts,x:req.session.financials});
});

x.post("/sale",function(req,res){
	var i = 0;
	while(i<req.session.financials.sdi.dscr.length){
